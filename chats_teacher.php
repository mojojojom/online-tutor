            ...
            <div class="col-3 p-0">
                <div class="c_banner-nav-wrap container border border-end-1 border-bottom-1 d-flex align-items-center">
                    <div class="c_banner-title-wrap d-flex align-items-center justify-content-between w-100">
                        <a href="dashboard.php" class="fw-bold btn-link text-decoration-none d-flex align-items-center gap-1 mb-0" style="font-size:12px;"><i class="fa-solid fa-hand-point-left"></i> BACK TO DASHBOARD</a>
